...
class ImageDiscriminator(Discriminator):
    def __init__(self, config, loss_identifier=None, patch_gan=None):
        ...
        self.target_dimensions = config["width"], config["height"], config["target-image-channels"]
    ...
    def create_architecture(self):
        ...
        tar = tf.keras.layers.Input(shape=self.target_dimensions, name='target_image')
